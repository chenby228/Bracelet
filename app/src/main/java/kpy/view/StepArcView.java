...
public class StepArcView extends View {
    ...
    private void drawArcYellow(Canvas canvas, RectF rectF) {
        ...
        /** 默认画笔颜色，黄色 */
        paint.setColor(getResources().getColor(R.color.chocolate,null));
        /** 结合处为圆弧*/
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(getResources().getColor(R.color.red,null));//设置画笔颜色
    ...
    private void drawTextNumber(Canvas canvas, float centerX) {
        ...
        vTextPaint.setColor(getResources().getColor(R.color.red,null));
